...
X = data.drop('transfer_logaritmo', axis=1)  # Replace 'transfer_logaritmo' with the actual column name if different
...
model_path = 'C:/Users/nadir/OneDrive/Escritorio/uni/TFG/models/xgb_model3.pkl'
